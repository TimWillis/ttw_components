...
exports.default = ({ callback, id = 'wysiwyg' + Date.now(), is_disabled = false, html, style }) => {
    ...
    function execCodeAction(button, editor) {
        if (button.classList.contains('active')) {
            // show visuell view
            (0, dom_diffing_1.default)('', htmlView['value'], 'div', visuellView);
    ...
    function selectionChange() {
        ...
        parentTagActive((_a = window.getSelection().anchorNode) === null || _a === void 0 ? void 0 : _a.parentNode);
    }
    function parentTagActive(elem) {
        var _a, _b, _c;
        // if (elem.classList.contains('visuell-view')) return false;
        if (!((elem && (elem === null || elem === void 0 ? void 0 : elem.closest) && (elem === null || elem === void 0 ? void 0 : elem.closest('.editor'))) == false ||
            !(elem === null || elem === void 0 ? void 0 : elem.tagName) ||
            ((_a = elem === null || elem === void 0 ? void 0 : elem.classList) === null || _a === void 0 ? void 0 : _a.contains('visuell-view'))))
            return false;
        let toolbarButton;
        // active by tag names
        let tagName = (_b = elem === null || elem === void 0 ? void 0 : elem.tagName) === null || _b === void 0 ? void 0 : _b.toLowerCase();
        toolbarButton = document.querySelectorAll(`.toolbar .btn[data-tag-name="${tagName}"]`)[0];
        if (toolbarButton) {
            toolbarButton.classList.add('active');
        }
        // active by text-align
        let textAlign = elem && ((_c = elem['style']) === null || _c === void 0 ? void 0 : _c.textAlign);
        toolbarButton = document.querySelectorAll(`.toolbar .btn[data-style="textAlign:${textAlign}"]`)[0];
        if (toolbarButton) {
            toolbarButton.classList.add('active');
        }
        return parentTagActive(elem === null || elem === void 0 ? void 0 : elem.parentNode);
    }
