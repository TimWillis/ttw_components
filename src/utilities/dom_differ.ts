export default () => {
  function e(t, o, n) {
    ...
    return (
      '#text' === t.nodeName || !isNaN(parseInt(t.nodeName))
        ...
        : (o
            ? (s = n.document.createElementNS('http://www.w3.org/2000/svg', t.nodeName))
            : 'svg' === t.nodeName.toLowerCase()
            ? ((s = n.document.createElementNS('http://www.w3.org/2000/svg', 'svg')), (o = !0))
            : (s = n.document.createElement(t.nodeName)),
          t.attributes &&
            Object.entries(t.attributes).forEach(function (e) {
              var t = e[0],
                o = e[1];
          ...
          t.childNodes &&
            t.childNodes.forEach(function (t) {
              return s.appendChild(e(t, o, n));
            }),
          n.valueDiffing &&
            (t.value && (s.value = t.value),
            t.checked && (s.checked = t.checked),
            t.selected && (s.selected = t.selected))),
      s
    );
  }
  function t(e, t) {
  ...
  function o(o, n, s) {
    var i,
      ...
      l,
      c,
      r = t(o, n[s._const.route]),
      u = { diff: n, node: r, newNode: undefined };
    ...
    switch (n[s._const.action]) {
      ...
      case s._const.modifyAttribute:
        if (!r || !r.setAttribute) return !1;
        r.setAttribute(n[s._const.name], n[s._const.newValue]),
          'INPUT' === r.nodeName && 'value' === n[s._const.name] && (r.value = n[s._const.newValue]);
        break;
      ...
      case s._const.replaceElement:
        r.parentNode.replaceChild(e(n[s._const.newValue], 'http://www.w3.org/2000/svg' === r.namespaceURI, s), r);
        break;
      case s._const.relocateGroup:
        Array.apply(void 0, new Array(n.groupLength))
          .map(function () {
      ...
      case s._const.addElement:
        (c = (l = n[s._const.route].slice()).splice(l.length - 1, 1)[0]),
          (r = t(o, l)).insertBefore(
            e(n[s._const.element], 'http://www.w3.org/2000/svg' === r.namespaceURI, s),
            r.childNodes[c] || null,
          );
        break;
      ...
      case s._const.addTextElement:
        if (
          ((c = (l = n[s._const.route].slice()).splice(l.length - 1, 1)[0]),
          (i = s.document.createTextNode(n[s._const.value])),
          !(r = t(o, l)) || !r.childNodes)
        )
          return !1;
  ...
  function s(e, t, s) {
    t.length || (t = [t]),
      ...
      t.forEach(function (t) {
        (function (e, t, s) {
          switch (t[s._const.action]) {
            case s._const.addAttribute:
              (t[s._const.action] = s._const.removeAttribute), o(e, t, s);
              break;
            case s._const.modifyAttribute:
              n(t, s._const.oldValue, s._const.newValue), o(e, t, s);
              break;
            case s._const.removeAttribute:
              (t[s._const.action] = s._const.addAttribute), o(e, t, s);
              break;
            case s._const.modifyTextElement:
            case s._const.modifyValue:
            case s._const.modifyComment:
            ...
            case s._const.replaceElement:
              ...
              break;
            case s._const.relocateGroup:
              n(t, s._const.from, s._const.to), o(e, t, s);
              break;
            case s._const.removeElement:
              (t[s._const.action] = s._const.addElement), o(e, t, s);
              break;
            case s._const.addElement:
              (t[s._const.action] = s._const.removeElement), o(e, t, s);
              break;
            case s._const.removeTextElement:
              (t[s._const.action] = s._const.addTextElement), o(e, t, s);
              break;
            case s._const.addTextElement:
              (t[s._const.action] = s._const.removeTextElement), o(e, t, s);
              break;
            default:
              console.log('unknown action');
          }
  ...
  function a(e) {
    ...
    return (
      ...
      '#text' !== e.nodeName &&
        '#comment' !== e.nodeName &&
        e.attributes &&
        (e.attributes.class && t.push(e.nodeName + '.' + e.attributes.class.replace(/ /g, '.')),
  ...
  function r(e) {
    return delete e.outerDone, delete e.innerDone, delete e.valueDone, !e.childNodes || e.childNodes.every(r);
  }
  function u(e, t) {
    if (
      !['nodeName', 'value', 'checked', 'selected', 'data'].every(function (o) {
        return e[o] === t[o];
      })
    )
      return !1;
    ...
    if (e.childNodes) {
      ...
      if (
        !e.childNodes.every(function (e, o) {
          return u(e, t.childNodes[o]);
        })
      )
        return !1;
    }
  ...
  function f(e, t, o, n) {
    var s = 0,
      ...
      l = e.length,
      r = t.length,
      u = Array.apply(void 0, new Array(l + 1)).map(function () {
        return [];
      }),
      h = c(e, t),
      f = l === r;
    ...
    for (var p = 0; p < l; p++)
      for (var m = e[p], _ = 0; _ < r; _++) {
        var V = t[_];
        o[p] || n[_] || !d(m, V, h, f)
          ? (u[p + 1][_ + 1] = 0)
          : ((u[p + 1][_ + 1] = u[p][_] ? u[p][_] + 1 : 1),
            u[p + 1][_ + 1] >= s && ((s = u[p + 1][_ + 1]), (i = [p + 1, _ + 1])));
      }
    return 0 !== s && { oldValue: i[0] - s, newValue: i[1] - s, length: s };
  }
  function p(e, t) {
  ...
  function _(e, t) {
    ...
    return { node: s, parentNode: o, nodeIndex: n };
  }
  function V(e, t, o) {
    return (
      t.forEach(function (t) {
        !(function (e, t, o) {
          var n,
            s,
            i,
            a = _(e, t[o._const.route]),
            l = a['node'],
            c = a['parentNode'],
            r = a['nodeIndex'],
            u = [],
            d = { diff: t, node: l };
          if (o.preVirtualDiffApply(d)) return !0;
          switch (t[o._const.action]) {
            case o._const.addAttribute:
              l.attributes || (l.attributes = {}),
                (l.attributes[t[o._const.name]] = t[o._const.value]),
                'checked' === t[o._const.name]
                  ? (l.checked = !0)
                  : 'selected' === t[o._const.name]
                  ? (l.selected = !0)
                  : 'INPUT' === l.nodeName && 'value' === t[o._const.name] && (l.value = t[o._const.value]);
              break;
            case o._const.modifyAttribute:
              l.attributes[t[o._const.name]] = t[o._const.newValue];
              break;
            case o._const.removeAttribute:
              delete l.attributes[t[o._const.name]],
                0 === Object.keys(l.attributes).length && delete l.attributes,
                'checked' === t[o._const.name]
                  ? (l.checked = !1)
                  : 'selected' === t[o._const.name]
                  ? delete l.selected
                  : 'INPUT' === l.nodeName && 'value' === t[o._const.name] && delete l.value;
              break;
            ...
            case o._const.replaceElement:
              ((n = h(t[o._const.newValue])).outerDone = !0),
                (n.innerDone = !0),
                (n.valueDone = !0),
                (c.childNodes[r] = n);
              break;
            case o._const.relocateGroup:
              l.childNodes
                .splice(t[o._const.from], t.groupLength)
                .reverse()
                .forEach(function (e) {
                  return l.childNodes.splice(t[o._const.to], 0, e);
                }),
                l.subsets &&
                  l.subsets.forEach(function (e) {
                    if (
                      t[o._const.from] < t[o._const.to] &&
                      e.oldValue <= t[o._const.to] &&
                      e.oldValue > t[o._const.from]
                    ) {
            ...
            case o._const.addElement:
              (s = t[o._const.route].slice()),
                (i = s.splice(s.length - 1, 1)[0]),
                (l = _(e, s)['node']),
                ((n = h(t[o._const.element])).outerDone = !0),
                (n.innerDone = !0),
                (n.valueDone = !0),
                l.childNodes || (l.childNodes = []),
                i >= l.childNodes.length ? l.childNodes.push(n) : l.childNodes.splice(i, 0, n),
                l.subsets &&
                  l.subsets.forEach(function (e) {
                    if (e.oldValue >= i) e.oldValue += 1;
                    else if (e.oldValue < i && e.oldValue + e.length > i) {
                      var t = e.oldValue + e.length - i;
                      u.push({ newValue: e.newValue + e.length - t, oldValue: i + 1, length: t }), (e.length -= t);
                    }
                  });
              break;
            case o._const.removeTextElement:
              c.childNodes.splice(r, 1),
                'TEXTAREA' === c.nodeName && delete c.value,
                c.subsets &&
                  c.subsets.forEach(function (e) {
                    e.oldValue > r
                      ? (e.oldValue -= 1)
            ...
            case o._const.addTextElement:
              (s = t[o._const.route].slice()),
                (i = s.splice(s.length - 1, 1)[0]),
                ((n = {})['nodeName'] = '#text'),
                (n.data = t[o._const.value]),
                (l = _(e, s)['node']).childNodes || (l.childNodes = []),
                i >= l.childNodes.length ? l.childNodes.push(n) : l.childNodes.splice(i, 0, n),
                'TEXTAREA' === l.nodeName && (l.value = t[o._const.newValue]),
                l.subsets &&
                  l.subsets.forEach(function (e) {
  ...
  function g(e, t) {
    ...
    if (((o.nodeName = e.nodeName), '#text' === o.nodeName || '#comment' === o.nodeName)) o.data = e.data;
      ...
      if ('TEXTAREA' === o.nodeName) o.value = e.value;
        ...
        (o.childNodes = []),
          Array.prototype.slice.call(e.childNodes).forEach(function (e) {
            return o.childNodes.push(g(e, t));
          });
      }
      t.valueDiffing &&
        (void 0 !== e.checked && e.type && ['radio', 'checkbox'].includes(e.type.toLowerCase())
          ? (o.checked = e.checked)
          : void 0 !== e.value && (o.value = e.value),
        void 0 !== e.selected && (o.selected = e.selected));
    }
    return o;
  }
  ...
  function E(e) {
    var t = { nodeName: '', attributes: {}, voidElement: undefined },
      o = e.match(/<\/?([^\s]+?)[/\s>]/);
    if (
      o &&
      ((t.nodeName = o[1].toUpperCase()),
      (y[o[1].toLowerCase()] || '/' === e.charAt(e.length - 2)) && (t.voidElement = !0),
      t.nodeName.startsWith('!--'))
    ) {
      var n = e.indexOf('--\x3e');
      return { type: 'comment', data: -1 !== n ? e.slice(4, n) : '' };
    }
    for (var s = new RegExp(b), i = null, a = !1; !a; )
      if (null === (i = s.exec(e))) a = !0;
      else if (i[0].trim())
        if (i[1]) {
          var l = i[1].trim(),
            c = [l, ''];
    ...
    return (function e(t) {
      ...
      (function (e, t) {
        ...
        var o,
          ...
          a = !1;
        return (
          e.replace(v, function (l, c) {
            if (a) {
              if (l !== '</' + o.nodeName + '>') return;
              a = !1;
            }
            var r,
              u = '/' !== l.charAt(1),
            ...
            if (d) {
              ...
              return s < 0
                ? (n.push(p), n)
                : ((r = i[s]) && (r.childNodes || (r.childNodes = []), r.childNodes.push(p)), n);
            }
            if (
              (u &&
                ((o = E(l)),
                s++,
                'tag' === o.type && t.components[o.nodeName] && ((o.type = 'component'), (a = !0)),
                o.voidElement ||
                  a ||
                  !f ||
                  '<' === f ||
                ...
                (i[s] = o)),
              (!u || o.voidElement) && (s--, !a && '<' !== f && f))
            ) {
              r = -1 === s ? n : i[s].childNodes || [];
              var m = e.indexOf('<', h),
  ...
  var x = function (e, t, o) {
    (this.options = o),
      (this.t1 =
        e instanceof HTMLElement ? g(e, this.options) : 'string' == typeof e ? k(e) : JSON.parse(JSON.stringify(e))),
      (this.t2 =
        t instanceof HTMLElement ? g(t, this.options) : 'string' == typeof t ? k(t) : JSON.parse(JSON.stringify(t))),
      (this.diffcount = 0),
      (this.foundAll = !1),
      this.debug && ((this.t1Orig = g(e, this.options)), (this.t2Orig = g(t, this.options))),
      (this.tracker = new m());
  };
  (x.prototype.init = function () {
    return this.findDiffs(this.t1, this.t2);
  }),
    (x.prototype.findDiffs = function (e, t) {
      var o;
      do {
        ...
        0 === (o = this.findNextDiff(e, t, [])).length &&
          (u(e, t) ||
            (this.foundAll
              ? console.error('Could not find remaining diffs!')
              : ((this.foundAll = !0), r(e), (o = this.findNextDiff(e, t, []))))),
          o.length > 0 && ((this.foundAll = !1), this.tracker.add(o), V(e, o, this.options));
      } while (o.length > 0);
      return this.tracker.list;
    }),
    (x.prototype.findNextDiff = function (e, t, o) {
      var n, s;
      if (this.options.maxDepth && o.length > this.options.maxDepth) return [];
      if (!e.outerDone) {
        if (
          ((n = this.findOuterDiff(e, t, o)),
          this.options.filterOuterDiff && (s = this.options.filterOuterDiff(e, t, n)) && (n = s),
          n.length > 0)
        )
          return (e.outerDone = !0), n;
        e.outerDone = !0;
      }
      if (!e.innerDone) {
    ...
    (x.prototype.findOuterDiff = function (e, t, o) {
      var n,
        s,
        a,
        l,
      ...
      if (e.nodeName !== t.nodeName) {
        if (!o.length) throw new Error('Top level nodes have to be of the same kind.');
        return [
          new i()
            .setValue(this.options._const.action, this.options._const.replaceElement)
            .setValue(this.options._const.oldValue, h(e))
            .setValue(this.options._const.newValue, h(t))
            .setValue(this.options._const.route, o),
        ];
      }
      if (
        o.length &&
        this.options.maxNodeDiffCount < Math.abs((e.childNodes || []).length - (t.childNodes || []).length)
      )
        return [
          new i()
            .setValue(this.options._const.action, this.options._const.replaceElement)
      ...
      for (
        s = e.attributes ? Object.keys(e.attributes).sort() : [],
          a = t.attributes ? Object.keys(t.attributes).sort() : [],
          l = s.length,
          r = 0;
        r < l;
        r++
          ...
          -1 === (c = a.indexOf(n))
            ? u.push(
                new i()
                  ...
                  .setValue(this.options._const.route, o)
                  .setValue(this.options._const.name, n)
                  .setValue(this.options._const.value, e.attributes[n]),
              )
            : (a.splice(c, 1),
              e.attributes[n] !== t.attributes[n] &&
                u.push(
                  new i()
                    .setValue(this.options._const.action, this.options._const.modifyAttribute)
                    .setValue(this.options._const.route, o)
                    .setValue(this.options._const.name, n)
                    .setValue(this.options._const.oldValue, e.attributes[n])
                    .setValue(this.options._const.newValue, t.attributes[n]),
                ));
        ...
        (n = a[r]),
          u.push(
            new i()
              ...
              .setValue(this.options._const.route, o)
              .setValue(this.options._const.name, n)
              .setValue(this.options._const.value, t.attributes[n]),
          );
      return u;
    }),
    (x.prototype.findInnerDiff = function (e, t, o) {
      var n = e.childNodes ? e.childNodes.slice() : [],
        s = t.childNodes ? t.childNodes.slice() : [],
        a = Math.max(n.length, s.length),
        l = Math.abs(n.length - s.length),
        c = [],
        r = 0;
      if (!this.options.maxChildCount || a < this.options.maxChildCount) {
        var d = e.subsets && e.subsetsAge--,
          m = d
            ? e.subsets
            : e.childNodes && t.childNodes
            ? (function (e, t) {
                for (
                  var o = e.childNodes ? e.childNodes : [],
                    n = t.childNodes ? t.childNodes : [],
                    s = p(o.length, !1),
                    i = p(n.length, !1),
                    a = [],
                    l: any = !0,
            ...
            : [];
        if (m.length > 0 && (c = this.attemptGroupRelocation(e, t, m, o, d)).length > 0) return c;
      }
      for (var _ = 0; _ < a; _ += 1) {
        var V = n[_],
          g = s[_];
            ...
            ? '#text' === V.nodeName
              ? (c.push(
                  new i()
                    ...
                    .setValue(this.options._const.route, o.concat(r))
                    .setValue(this.options._const.value, V.data),
                ),
                (r -= 1))
              : (c.push(
                  new i()
                    ...
                    .setValue(this.options._const.route, o.concat(r))
                    .setValue(this.options._const.element, h(V)),
                ),
                (r -= 1))
            : g &&
              !V &&
              ('#text' === g.nodeName
                ? c.push(
                    new i()
                      ...
                      .setValue(this.options._const.route, o.concat(r))
                      .setValue(this.options._const.value, g.data),
                  )
                : c.push(
                    new i()
                      .setValue(this.options._const.action, this.options._const.addElement)
                      .setValue(this.options._const.route, o.concat(r))
                      .setValue(this.options._const.element, h(g)),
                  ))),
          V &&
            g &&
            (!this.options.maxChildCount || a < this.options.maxChildCount
              ? (c = c.concat(this.findNextDiff(V, g, o.concat(r))))
              : u(V, g) ||
                (n.length > s.length
                  ? ('#text' === V.nodeName
                      ? c.push(
                  ...
                  : (c = c.concat([
                      new i()
                        .setValue(this.options._const.action, this.options._const.replaceElement)
                        .setValue(this.options._const.oldValue, h(V))
                        .setValue(this.options._const.newValue, h(g))
                        .setValue(this.options._const.route, o.concat(r)),
                    ])))),
          (r += 1);
      }
    ...
    (x.prototype.attemptGroupRelocation = function (e, t, o, n, s) {
      for (
        var a,
          l,
          c,
          ...
          f,
          m = (function (e, t, o) {
            var n = e.childNodes ? p(e.childNodes.length, !0) : [],
              s = t.childNodes ? p(t.childNodes.length, !0) : [],
              i = 0;
            return (
        ...
        if (!s || (!0 !== _[N] && !0 !== V[N])) {
          if (!0 === _[N])
            if ('#text' === (r = e.childNodes[b]).nodeName)
              if ('#text' === t.childNodes[N].nodeName) {
                if (r.data !== t.childNodes[N].data) {
                  for (f = b; e.childNodes.length > f + 1 && '#text' === e.childNodes[f + 1].nodeName; )
                    if (((f += 1), t.childNodes[N].data === e.childNodes[f].data)) {
                      u = !0;
                      break;
                    }
                  if (!u)
                    return (
                      v.push(
                        new i()
                          .setValue(this.options._const.action, this.options._const.modifyTextElement)
                          .setValue(this.options._const.route, n.concat(N))
                          .setValue(this.options._const.oldValue, r.data)
                          .setValue(this.options._const.newValue, t.childNodes[N].data),
                      ),
                      v
                    );
                }
                ...
                v.push(
                  new i()
                    .setValue(this.options._const.action, this.options._const.removeTextElement)
                    .setValue(this.options._const.route, n.concat(N))
                    .setValue(this.options._const.value, r.data),
                ),
                  _.splice(N, 1),
                  (g = Math.min(_.length, V.length)),
                  (N -= 1);
              ...
              v.push(
                new i()
                  .setValue(this.options._const.action, this.options._const.removeElement)
                  .setValue(this.options._const.route, n.concat(N))
                  .setValue(this.options._const.element, h(r)),
              ),
                _.splice(N, 1),
                (g = Math.min(_.length, V.length)),
                (N -= 1);
          else if (!0 === V[N])
            '#text' === (r = t.childNodes[N]).nodeName
              ? (v.push(
                  new i()
                    .setValue(this.options._const.action, this.options._const.addTextElement)
                    .setValue(this.options._const.route, n.concat(N))
            ...
            if (((c = o[_[N]]), (l = Math.min(c.newValue, e.childNodes.length - c.length)) !== c.oldValue)) {
              a = !1;
              for (var w = 0; w < c.length; w += 1)
                d(e.childNodes[l + w], e.childNodes[c.oldValue + w], [], !1, !0) || (a = !0);
              if (a)
                return [
                  new i()
                    .setValue(this.options._const.action, this.options._const.relocateGroup)
                    .setValue('groupLength', c.length)
                    .setValue(this.options._const.from, c.oldValue)
    ...
    (x.prototype.findValueDiff = function (e, t, o) {
      var n = [];
      return (
  ...
  (D.prototype.apply = function (e, t) {
    ...
    (D.prototype.undo = function (e, t) {
      return s(e, t, this.options);
    }),
    (D.prototype.diff = function (e, t) {
  ...
  (O.prototype.fin = function (e, t) {
    (this.padding += this.pad), this.log('├─> entering ' + e, t);
  }),
    (O.prototype.fout = function (e, t) {
    ...
    (O.prototype.toString = function () {
      ...
      var t = this.padding;
      return (
        (this.padding = ''), (e = this.format(e, this.tick)), (this.padding = t), this.messages.join('\n') + '\n' + e
      );
    });
  // (exports.DiffDOM = D),
  // (exports.TraceLogger = O),
  // (exports.nodeToObj = g),
  // (exports.stringToObj = k);
